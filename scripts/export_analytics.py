...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export offline research analytics from the SQLite audit chain.")
    ...
    parser.add_argument("--out-dir", default="data/reports", help="Directory for JSON/CSV exports.")
...
def main() -> None:
    ...
    try:
        ...
        written = export_analytics_report(report, out_dir=args.out_dir)
    finally:
        service.close()
